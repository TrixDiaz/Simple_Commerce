        ...
        <div class="badge bg-primary text-uppercase" id="currentTimeDate"></div>
         ...
         <div class="d-flex justify-content-between mb-3">
			...
			//=== APPLICATION: Check data from DB
				...
				$query = "SELECT * FROM $tablename WHERE category='$categ'";
					...
					if ($count > 0) {
						...
						while ($row = mysqli_fetch_assoc($result)) {
							...
							$data_category = $row['category'];
									...
									?>
                                        <tr>
                                        <th scope="row"> <?php echo $data_id; ?></th>
                                        <td><?php echo $data_productname; ?></td>
                                        <td><?php echo $data_category; ?></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="col-4">
                ...
                <div class="col-4">
				<a href="products.php?category=Grooming"> Grooming </a>
